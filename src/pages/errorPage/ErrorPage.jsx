...
const ErrorPage = () => {
    return (
        <section className="flex justify-center items-center h-[90vh] bg-white dark:bg-gray-900">
            <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                ...
                <div className="flex justify-center items-center">
                    <Link to="/" className="btn btn-wide bg-slate-600 hover:slate-900 text-white font-bold text-xl">
                        <FaFastBackward />
                        Go Home</Link>
                </div>
            </div>
